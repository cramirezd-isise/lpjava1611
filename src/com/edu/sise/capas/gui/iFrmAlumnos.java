...
import com.edu.sise.capas.logic.TutorLogic;
 ...
 * @author Carlos
 */
public class iFrmAlumnos extends javax.swing.JInternalFrame {

    /**
     * Creates new form iFrmAlumnos
     */
    AlumnoLogic logic;
    ProvinciaLogic logicProvincia;
    TutorLogic logicTutor;
    int pagina = 0;
    int contador=0;
    int total=0;
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            objAlumno = getAlumno();
            objAlumno.setId_alum(0);
            logic.insertar(objAlumno);
    ...
    private void tbListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbListaMouseClicked
        ...
        if(fila>=0){
            ...
            logicProvincia.buscarCB(cbProvincias, id_prov);
             //logica para seleccionar un elemento en el combobox
            logicTutor.buscarCB(cbTutores, id_tutor);
        }
...
//        }
    ...
    Alumno getAlumno(){
        ...
        return new Alumno(
                ...
                txtTelefono.getText(),
                ((Tutor)cbTutores.getSelectedItem()).getId_tutor(),
    ...
    private void llenarTutoresCB(){
        logicTutor = new TutorLogic();
        try {
            logicTutor.imprimirCB(cbTutores);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
        }
    }
